...
콘솔창에 주인공이 ICE BOLT라는 스킬을 사용하는 코드를 작성했는데 실행하는 순간 전율을 느낀 적이 있다. 
```
user@hostname:~$ * shoots an ice bolt at target *
```
게임은 새로운 세계를 창조하는 일종의 예술이기 때문의 예술의 희열을 느낄 수 있다.

<img src="https://github.com/jeekpark/jeekpark.github.io/blob/main/assets/images/posts_img/life/classificatory-disputes-about-art.png?raw=true">
프랑스의 예술 분류법. 제10의 예술 - 게임
